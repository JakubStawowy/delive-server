...
@Service
public final class ReverseEmergencyGeocodingService extends EmergencyGeocodingService {

    @Autowired
    public ReverseEmergencyGeocodingService(IHttpClientService httpClientService, IResponseJsonConverter converter) {
