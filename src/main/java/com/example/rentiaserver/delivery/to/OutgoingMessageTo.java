...
public class OutgoingMessageTo extends MessageTo {
    ...
    public OutgoingMessageTo(Long id, String createdAt, Long orderId, Long senderId, Long receiverId, String message, String vehicleRegistrationNumber, String phoneNumber, String messageType, boolean replied) {
